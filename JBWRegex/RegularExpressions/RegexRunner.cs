...
namespace JBWRegex.RegularExpressions
{
    ...
    abstract internal class RegexRunner {
        ...
        protected internal List<Word> runwordlist;
...
*/
        ...
        internal
#endif
        Match Scan(Regex regex, List<Word> wordList, int textbeg, int textend, int textstart, int prevlen, bool quick, TimeSpan timeout)
        {
        ...
        private void InitMatch2()
        {
            ...
            {
                if (runregex.caps != null)
                    runmatch = new MatchSparse(runregex, runregex.caps, runregex.capsize, runwordlist, runtextbeg, runtextend - runtextbeg, runtextstart);
                else
                    runmatch = new Match(runregex, runregex.capsize, runwordlist, runtextbeg, runtextend - runtextbeg, runtextstart);
            }
            else
            {
                runmatch.Reset(runregex, runwordlist, runtextbeg, runtextend, runtextstart);
            }
